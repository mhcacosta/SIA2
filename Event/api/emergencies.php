...
switch ($method) {
    ...
    case 'POST':
        // Handle POST request (report new emergency)
        ...
        $stmt = $conn->prepare("INSERT INTO emergencies (location, description, media, status) VALUES (?, ?, ?, 'active')");
        $stmt->bind_param("sss", $location, $description, $media);
